...
class RegistrationsController extends Controller
{
    public function index(Request $request)
    {
        $registration = DB::table('registrations')
            ...
            ->select('no_pendaftaran','nisn','nama','alamat','tempat_lahir','tanggal_lahir','asal_sekolah','jenis_kelamin','jurusan','nama_ayah','pekerjaan_ayah','nama_ibu','pekerjaan_ibu','penghasilan_orang_tua','foto',)
    ...
    public function store(StoreRegistrationRequest $request)
    {
        ...
        return redirect(route('registrations.index'))->with('success', 'Create New Register Successfully');
    }
    ...
    public function update(UpdateRegistrationRequest $request, Registrations $registration)
{
    ...
    return redirect()->route('registrations.index')->with('success', 'Edit Schedule Successfully');
...
{
        $registration->delete();
        return redirect(route('registrations.index'))->with('success', 'Delete Register Successfully');
}
